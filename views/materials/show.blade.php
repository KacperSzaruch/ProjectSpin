                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card card-stats mb-12 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h1 font-weight-bold mb-0" style="font-size: 45px;">{{$material->title}}</span>
                                    </div>                                    
                                        <div class="col-lg-6 col-5 text-right">
                                        @if (auth()->user()->id == $material->userID)
                                        <a href="/material/delete/{{ $material->id}}" class="btn btn-sm btn-danger">Usuń</a>                                                      
                                        @endif
                                    </div>
                                 </div>
                                 </br></br></br></br>
                                 <h4 class="card-title text-uppercase  mb-0"style="font-size: 25px;">Opis</h4>
                                 <span class="h3 font-weight-bold mb-0">{{$material->content}}</span>
                                    </br></br>  </br> 
                                 <h4 class="card-title   mb-0"style="font-size: 25px;">Pliki do pobrania:</h4>
                                 <span class="h3 font-weight-bold mb-0 ml-1"><a href="#">{{$material->filename}}</a></span>
                                   </br></br>  </br> 
